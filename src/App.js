...
import { FaEnvelope, FaLinkedin, FaBars, FaTimes, FaSun, FaMoon } from 'react-icons/fa';
...
<section id="professionalexperience" className="py-20 bg-gray-100 dark:bg-black px-4">
  ...
  <div className="max-w-4xl mx-auto relative">
    ...
    <div className="mb-12 ml-12 relative">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow duration-300 mr-4">
        <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
          ESoftage Lahore <span className="text-sm text-gray-500 dark:text-gray-300">— Software Development Intern</span>
        </h3>
    ...
    <div className="ml-12 relative">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow duration-300 mr-4">
        <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
          GigaLabs (Pvt) Ltd Lahore <span className="text-sm text-gray-500 dark:text-gray-300">— Backend Development Intern</span>
        </h3>
            ...
            <div className="grid grid-cols-1 px-4 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="p-4 border rounded-lg bg-white dark:bg-gray-800 shadow hover:shadow-lg transition text-center">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-300 mt-3">
                  <p className='font-bold'>Tools & Technologies used:</p>Adobe XD, React Native, Flask, Python, Postman, Git, Github, Android Studio, MongoDB Compass
                  </p>
                {/* <a 
              ...
              <div className="p-4 border rounded-lg bg-white dark:bg-gray-800 shadow hover:shadow-lg transition text-center">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-300 mt-3">
                  <p className='font-bold'>Tools & Technologies used:</p>ReactJS, HTML, TailwindCSS 
                  </p>
                {/* <a 
                 href="https://github.com/shehneelafarman/CryptoAnalyzer" 
                 target="_blank"
              ...
              <div className="p-4 border rounded-lg bg-white dark:bg-gray-800 shadow hover:shadow-lg transition text-center">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-white text-center">Tracker Hub</h3>
                <p className="text-sm text-gray-500 dark:text-gray-300 text-center mt-1">
                  Web-based project that tracks parcel by ID.
                </p>
                <p className="text-xs text-gray-600 dark:text-gray-300 mt-3">
                  <p className='font-bold'>Tools & Technologies used:</p>Adobe XD, HTML, CSS, JS, Laravel, PHP
                  </p>
                {/* <a 
                 href="https://github.com/shehneelafarman/CryptoAnalyzer" 
                 target="_blank"
              ...
              <div className="p-4 border rounded-lg bg-white dark:bg-gray-800 shadow hover:shadow-lg transition text-center">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-white text-center">COMSATS University UI Clone</h3>
                <p className="text-sm text-gray-500 dark:text-gray-300 text-center mt-1">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-300 mt-3">
                  <p className='font-bold'>Tools & Technologies used:</p>HTML, CSS, JS
                  </p>
                {/* <a 
              ...
              <div className="p-4 border rounded-lg bg-white dark:bg-gray-800 shadow hover:shadow-lg transition text-center">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-white text-center">Amazon UI Clone</h3>
                <p className="text-sm text-gray-500 dark:text-gray-300 text-center mt-1">
  ...
  <div className="max-w-5xl mx-auto text-center">
    ...
    <div className="flex justify-center gap-8 text-4xl">
      ...
      <footer className="bg-gray-800 dark:bg-black text-center py-4 text-sm text-white">
        Made by Shehneela Farman &copy; {new Date().getFullYear()}
      </footer>
